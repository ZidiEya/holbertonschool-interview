#include "sandpiles.h"
/**
 * stable - function to check if a sandpile is stable or unstable
 * @arr: 3x3 grid
...
/**
 * print_grid - fucntion to print 3x3 grid
 * @grid: 3x3 grid
 */
...
/**
 * copy_result - function to copy result from arr_from to arr_to
 * @arr_from: 3x3 grid
 * @arr_to: 3x3 grid
 */
...
/**
 * new_grid - function to make new grid
...
/**
 * sandpiles_sum - function to computes the sum of two sandpiles
